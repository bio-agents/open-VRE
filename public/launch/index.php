		...
		<div class="page-content-wrapper">
			...
			<div class="page-bar">
			    <ul class="page-breadcrumb">
			      ...
			      <li>
					<span>Launch Agent / Visualizer</span>
						<i class="fa fa-circle"></i>
						</li>
						<li>
			...
			<!-- END PAGE BAR -->
			<!-- BEGIN PAGE TITLE-->
			<h1 class="page-title"> Select Agent 
			  ...
			  <div class="col-md-12 col-sm-12">
				...
				<div class="portlet light bordered">
					...
					<div class="portlet-title">
					    	...
					    	<span class="caption-subject font-dark bold uppercase">Select a agent</span>
							</div>
            ...
            <!-- CHANGE: new id "portlet-ws" -->
              ...
              <div class="row">
                            ...
                            $kwt = array();
							foreach($agentList as $t) { 
								foreach($t['keywords_agent'] as $tk) $kwt[] = $tk;
							}
              ...
              <div class="row">
                  ...
                  <table id="agents-list" class="table table-striped table-bordered table-hover">
            	      <thead>
                      <tr>
                        <th></th>
                      	<th>Agent</th>
			...
			<th>visualizer</th>
                    ...
                    <tbody>
										...
										$comb = getInputFilesCombinations($agent);
												//vaR_dump($agent["input_files_combinations"]["description"]); ?>
												<tr class="first-level-tr">
													<td></td>
													<td><?php echo $agent["name"]; ?></td>
													<td><?php echo $agent["short_description"]; ?></td>
													<td><?php echo $agent["owner"]["author"]; ?></td>
													<td><?php echo $comb; ?></td>
													<!-- TO MODIFY WITH LONG DESCRIPTION -->
													<td><?php echo $agent["long_description"]; ?></td>
													<!-- TO MODIFY WITH NEW "secondary kws" -->
													<td><?php echo implode(", ", $agent["keywords_agent"]); ?></td>
													<td><?php echo implode(", ", $agent["keywords"]); ?></td>
													<td><?php echo $agent["_id"]; ?></td>
													<td><?php if (isset($agent['visualizers'])){echo $agent["visualizer"];} ?></td>
												</tr>
											<?php } ?>
                    </tbody>
                  </table>
