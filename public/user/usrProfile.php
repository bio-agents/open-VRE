                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <form role="form" action="javascript:;" id="form-change-profile">
                                                        ...
                                                        <!-- <?php //if (!allowedRoles($_SESSION['User']['Type'], $GLOBALS['TOOLDEV']) && (checkTermsOfUse())) { ?>
                                                            <div class="form-group margin-top-30">
                                                                <label class="control-label">You are a standard user. Do you want to bring your own agent?
                                                                    <a href="http://www.multiscalegenomics.eu/MuGVRE/policy/" target="_blank"><i class="icon-question agenttips" data-container="body" data-placement="right" data-original-title="Click here to read more about how to bring your own agent."></i></a>
                                                                </label>
                                                                <br /><br />
                                                                <a href="<?php //echo $GLOBALS['BASEURL']; ?>helpdesk/?sel=agentdev" class="btn green">Become agent developer</a></div>
                                                        <?php //} ?> -->
                                                        <div class="form-group margin-top-30">
                                                ...
                                                <div class="tab-pane" id="tab_1_4">
                                                    ...
                                                    <div class="form-group mt-clipboard-container">
                                                        <label class="control-label">Access Token <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Bearer token used to authenticate your access to any platform service.</p>"></i></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label">Expiration date <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Access token expiration time. Its lifespan is short, so VRE refreshs it just before accessing the requested resource, if needed.</p>"></i></label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group mt-clipboard-container">
                                                        <label class="control-label">Refresh Token <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Token used to refresh an expired access token. It is revoked when used, so access tokens are issued together with a new refresh token</p>"></i></label>
                                                        <div class="input-group">
                                                    ...
                                                    ?>
                                                    <div class="form-group">
                                                        <label class="control-label">Expiration date <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Refresh token expiration time. A new SSO session is required to obtain a new pair of tokens.</p>"></i></label>
                                                        <input id="refrtoken-exp-date" type="text" value="" class="form-control" readonly style="background:#fff;" /> </div>


                                                    <div class="form-group">
                                                        <label class="control-label">Token User information<i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Information returned by Oauth2 provider when the user token is beared</p>"></i></label>
                                                        <br />
