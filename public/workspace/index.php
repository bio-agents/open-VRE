...
$kk = $GLOBALS['agentsCol']->find(array("external" => true), array("input_files_combinations_internal" => true));

// Agents list
$dtlist = ( (isset($_REQUEST["agent"]) && $_REQUEST["agent"] != "")?  getAvailableDTbyAgent($_REQUEST["agent"]) : array() );
				...
				<?php if (isset($_REQUEST["from"]) && $_REQUEST["from"]) { ?>
					...
					<div class="row">
						<div class="col-md-12" style="margin-bottom:30px;">
							<?php require "../agents/" . $_REQUEST["from"] . "/assets/ws/btn-modal.php"; ?>
						</div>
					</div>
									...
									<div class="portlet light bordered">
										...
										<div class="portlet-body">
											...
											<div class="input-group" style="margin-bottom:20px;">
												...
												<select class="form-control" style="width:100%;" onchange="loadWSAgent(this)">
													<option value="">Filter files by agent</option>
													<?php foreach ($agentsList as $tl) { ?>
														<option value="<?php echo $tl["_id"]; ?>" <?php if (isset($_REQUEST["agent"]) && $_REQUEST["agent"] == $tl["_id"]) echo 'selected'; ?>><?php echo $tl["name"]; ?></option>
													<?php } ?>
												</select>
											</div>
											...
											if (isset($_REQUEST["agent"])){
												print "input type=\"hidden\" id=\"agentSelected\" value=\"".$_REQUEST['agent']."\"";
											}
						...
						<div class="col-md-12 col-sm-12">
							<div class="portlet light bordered">
								<div class="portlet-title">
									...
									<div class="actions" style="display:none!important;" id="btn-av-agents">
										<div class="btn-group">
										...
										<div class="btn-group">
											<a class="btn btn-sm blue-dark" id="av_agents" href="javascript:;" data-toggle="dropdown">
												<i class="fa fa-wrench"></i> Available Agents
												<i class="fa fa-angle-down"></i>
											</a>
											<ul class="dropdown-menu pull-right" id="av_agents_list" role="menu"> </ul>
										</div>
									</div>
								</div>
								...
								<div class="portlet-body">
									<div class="" data-always-visible="1" data-rail-visible="0">
										<ul class="feeds" id="list-files-run-agents"></ul>
										<div id="desc-run-agents">In order to run the agents on the files, please select them clicking on the checkboxes from the table above.</div>
									</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption">
										...
										if (isset($_REQUEST["agent"]) && $_REQUEST["agent"] != "") {
											...
											<small>Below users can find all the possible data type combinations for the selected agent</small>
										...
										?>
											...
											<small style="font-size:75%;">Below users can find all the possible data type combinations for each agent (click expand button)</small>
								...
								<div class="portlet-body <?php echo $portlet; ?>">
									...
									<?php if (isset($_REQUEST["agent"]) && $_REQUEST["agent"] != "") { ?>

										<!--<p>Below users can find all the possible data type combinations for the selected agent:</p>-->

									<?php } else { ?>

										<!--<p>Below users can find all the possible data type combinations for each agent:</p>-->
									...
									<?php if (isset($_REQUEST["agent"]) && $_REQUEST["agent"] != "") { ?>
										...
										<div class="panel-group accordion" id="accordion1">
											<?php
											$c = 0;
											foreach ($agentsList as $tl) {

												if ($tl["_id"] == $_REQUEST["agent"]) {
													?>
											...
											foreach ($agentsList as $tl) {
												...
												<div class="panel panel-default">
													...
													<div id="collapse_<?php echo $c; ?>" class="panel-collapse collapse">
														...
														<div class="panel-body">
															<table class="table ws-help-agents">
																<thead>
																	<tr>
																		<th>Operations</th>
																		<th>File(s) required</th>
			...
			<div class="modal fade bs-modal-sm" id="myModal1" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body"> You have more than one file selected. If you go ahead, this agent will just be applied to the selected file. </div>
...
-->
			...
			if (isset($_REQUEST["from"]) && $_REQUEST["from"]) {
				...
				require "../agents/" . $_REQUEST["from"] . "/assets/ws/modal.php";
			}
