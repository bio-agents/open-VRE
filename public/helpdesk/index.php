                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="Request" id="Request" class="form-control">
                                                    ...
                                                    <option value="agents" <?php if ($_REQUEST["sel"] == "agents") { ?>selected<?php } ?>>I have an issue related with some agent</option>
                                                    ...
                                                    <!-- <option value="agentdev" <?php 
                                                                                    ?>selected<?php 
                                                                                                                                        ?>>I want to become a agent developer</option> -->
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row display-hide" id="row-agents">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Agents List</label>
                                                <select name="Agent" id="Agent" class="form-control" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <?php if ($_REQUEST["sel"] != "agentdev") { ?>
                                                    <label class="control-label" id="label-msg">Message details</label>
                                                <?php } else { ?>
                                                    <label class="control-label" id="label-msg">Please tell us which kind of agent(s) you want to integrate in the VRE</label>
                                                <?php } ?>
