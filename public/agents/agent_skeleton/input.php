...
InputAgent_checkRequest($_REQUEST);

$from = InputAgent_getOrigin($_REQUEST);

list($rerunParams,$inPaths) = InputAgent_getPathsAndRerun($_REQUEST);

$dirName = InputAgent_getDefExName();

// get agent details
$agentId = "agent_skeleton";
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-container-bg-solid page-sidebar-fixed">
  ...
  <?php require "../../htmlib/menu.inc.php"; ?>
	...
	<div class="page-content">
    	...
    	<!-- BEGIN PAGE TITLE-->
    	<h1 class="page-title"> <?php echo $agent['title']; ?> </h1>
    	<!-- END PAGE TITLE-->
    	...
    	<div class="row">
		    ...
		    <div class="row">
    			<div class="col-md-12">
    				...
    				<div class="row step-line">
    					...
    					<div class="mt-step-title uppercase font-grey-cascade">Select agent</div>
    				    </div>
    				    <div class="col-md-6 mt-step-col last active">
    					<div class="mt-step-number bg-white">2</div>
    					<div class="mt-step-title uppercase font-grey-cascade">Configure agent</div>
    				    </div>
    				</div>
    			    </div>
    			 </div>
    		...
    		<?php } ?>
 		<form action="#" class="horizontal-form" id="agent-input-form">
		    <input type="hidden" name="agent" value="<?php echo $agentId;?>" />
		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		     ...
		     <div class="portlet-body form">
			   ...
			   <div class="row">
				   ...
				   <div class="form-group">
					...
					<?php InputAgent_getSelectProjects(); ?>
				   </div>
			       </div>
			       <div class="col-md-6">
				   <div class="form-group">
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
		     <div class="portlet-title">
			 <div class="caption">
			  <i class="fa fa-cogs" ></i> Agent settings
			 </div>
		     </div>
			 ...
			 <div class="form-body">
				...
				<?php if( $_REQUEST["op"] == 0 ) {  ?>
					<div class="col-md-12">
						<?php $ff = matchFormat_File($agent['input_files']['fasta1']['file_type'], $inPaths); ?>
						<?php InputAgent_printSelectFile($agent['input_files']['fasta1'], $rerunParams['fasta1'], $ff[0], false, true); ?>
					</div>
				<?php } else { ?>
					<div class="col-md-6">
						<?php $ff = matchFormat_File($agent['input_files']['fasta1']['file_type'], $inPaths); ?>
					...
					<div class="col-md-6">
						<?php $ff = matchFormat_File($agent['input_files']['fasta2']['file_type'], $inPaths); ?> 
						<?php InputAgent_printSelectFile($agent['input_files']['fasta2'], $rerunParams['fasta2'], $ff[0], false, true); ?>
					</div>
				<?php } ?>
			     </div>
			     ...
			     <?php InputAgent_printSettings($agent['arguments'], $rerunParams); ?>
			</div>
		     </div>
		 </div>
		 </div>
