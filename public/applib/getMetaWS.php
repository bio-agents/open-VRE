...
if($_REQUEST["type"] != 2) {
    ...
    $agent = getAgent_fromId($mt["agent"],1);
}else{
...
<table class="table table-striped table-bordered">
	<tbody><tr>
			<th><b>Valid Metadata
                <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>This file has missing or incorrect metadata. Please, click 'Validate Metadata' and fill in the form.</p>"></i>
            </b></th>
        	</tr>
			<tr>
...
<table class="table table-striped table-bordered">
	...
	if (count($mt['input_files'])){ ?>
             <ul class="feeds" id="list-files-run-agents">
	...
	<tbody><tr>
			...
			<tr>
                ...
                foreach ($mt["arguments"] as $k => $v){
                    if (isset($agent['arguments'][$k]['description'])){
                        $k = $agent['arguments'][$k]['description'];
                    }
                    if(gettype($v) == "array") {
						echo "<tr><td>$k</td><td>";
...
}elseif(isset($agent['infrastructure']['memory'])){
    $mem  = $agent['infrastructure']['memory'];
...
<div id="meta-log">
		...
		<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>Fie not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW LOG FILE </a>
		<?php } 
        ...
        if(($_SESSION['User']['Type'] == 0) || ($_SESSION['User']['Type'] == 1)) { ?>
			...
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>Fie not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW SUBMIT FILE </a>
			<?php } ?>
			...
			<?php }elseif(file_exists($GLOBALS['dataDir'].$mt['path']."/".$GLOBALS['agent_config_file']) ) { ?>
			<a href="workspace/workspace.php?op=openPlainFileFromPath&fnPath=<?php echo urlencode($mt['path']."/".$GLOBALS['agent_config_file']); ?>" class="btn green" target="_blank"><i class="fa fa-cog"></i> VIEW CONFIG FILE </a>
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>Fie not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW CONFIG FILE </a>
			<?php } ?>
			...
			<?php }elseif(file_exists($GLOBALS['dataDir'].$mt['path']."/".$GLOBALS['agent_metadata_file']) ) { ?>
			<a href="workspace/workspace.php?op=openPlainFileFromPath&fnPath=<?php echo urlencode($mt['path']."/".$GLOBALS['agent_metadata_file']); ?>" class="btn green" target="_blank"><i class="fa fa-tags"></i> VIEW META FILE </a>
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>Fie not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW META FILE </a>
			<?php } ?>
			...
			<?php }elseif(file_exists($GLOBALS['dataDir'].$mt['path']."/".$GLOBALS['agent_stageout_file']) ) { ?>
			<a href="workspace/workspace.php?op=openPlainFileFromPath&fnPath=<?php echo urlencode($mt['path']."/".$GLOBALS['agent_stageout_file']); ?>" class="btn green" target="_blank"><i class="fa fa-line-chart"></i> VIEW RESULTS FILE </a>
			<?php }else{ ?>
			<a href="javascript:;" class="btn grey agenttips" data-container="body" data-html="true" data-placement="bottom" data-original-title="<p align='left' style='margin:0'>Fie not available</p>"><i class="fa fa-exclamation-triangle"></i> VIEW RESULTS FILE </a>
			<?php }
        } ?>
</div>
