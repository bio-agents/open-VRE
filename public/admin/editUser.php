                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="Type" id="Type" class="form-control">
                                                		...
                                                		<?php } ?>
																				...
																				$stAgents = "enabled";
																				if($user['Type'] != 1) {
																					$dispAgents = "display-hide";
																					$stAgents = "disabled";
																				}
																				?>

																				<div class="row agents_select <?php echo $dispAgents; ?>">
                                            <div class="col-md-12">
                                            	<div class="form-group">
																								<label class="control-label">Agents permissions <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Select the agents this user will be able to administer.</p>"></i></label>
																								<select class="form-control form-field-enabled valid select2agents" name="agents[]" id="agents" aria-invalid="false" multiple="multiple" <?php echo $stAgents; ?>>
																									<option value=""></option>
																									<?php
																									foreach ( $tlsvlzrs as $id => $value ) {
																											$selected="";
                                                    	if (in_array($value['_id'], $user['AgentsDev'])) $selected = "selected";
