...
// show agent_dev agent logs
if ( $_SESSION['User']['Type'] == 1){
    if (! $_SESSION['User']['AgentsDev'] ){
        $_SESSION['errorData']['Error'][]="Your account owns no agents. Sorry, no logs to show";
        $filters = array("force" => "empty");
    }
    $filters = array("agentId" => array('$in' => $_SESSION['User']['AgentsDev']));
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <h1 class="page-title"> Logs
                            <small>for agent executions</small>
