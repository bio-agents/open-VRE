...
<!-- BEGIN CONTENT -->
			...
			<?php  
				...
				<form name="new-agent" id="new-agent" action="applib/createNewAgentID.php" method="post" >

				<div class="portlet box blue-oleo">
                                  <div class="portlet-title">
                                      <div class="caption">
																				<div style="float:left;margin-right:20px;"> <i class="fa fa-plus" ></i> First of all, you must provide a new and unique agent ID</div>
                                      </div>
                                  </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">
																										...
																										<input type="text" name="agentid" id="agentid" value="" class="form-control" >
                                                </div>
                                            </div>
                                        </div>
