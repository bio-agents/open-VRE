...
$response_d = '[
    {
      ...
      "_schema": "https://www.iechor-europe.org/excelerate/WP2/json-schemas/0.4#Dataset",
      "community_id": "CAMEO",
      "dataset_contact_ids": [
        "help.CAMEO-3D"
      ],
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align:middle;">
                                                            <a href="applib/getData.php?uploadType=repository&url=<?php echo "$URL"; ?>&community=<?php echo "$obj->community_id"; ?>&type=<?php echo "$obj->type" ?>&id=<?php echo "$obj->_id" ?>">
                                                                <i class="font-green fa fa-download agenttips" aria-hidden="true" style="font-size:22px;" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Import dataset to workspace</p>"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                            endif;
