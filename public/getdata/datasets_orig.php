			...
			foreach (getDatasets() as $obj) {
				...
				"description"      => $obj->description,
                            ...
                            <!-- <a <?php //if(!$dataset_uri){echo 'class="disabled" style="opacity: 0.4;"';}?> href="applib/getData.php?<?php //echo $GET_metadata; ?>">
                              <i class="font-green fa fa-download agenttips disabled" aria-hidden="true" style="font-size:22px;" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Import dataset to workspace</p>"></i></a> -->
				...
				<button type="submit" class="btn green dropdown-toggle" value="submit">
				    <i class="fa fa-download agenttips font-white" data-original-title="Import dataset to workspace"></i>
				</button>
			    </form>
