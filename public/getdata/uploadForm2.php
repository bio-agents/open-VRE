				...
				<div class="note note-info formInputs" id="formInputs<?php echo $idx;?>" style="position:relative;">
				  ...
				  <div class="form-group formatTR" id="formatTR<?php echo $idx;?>">
					...
					<div class="form-group display-hide" id="dataType<?php echo $idx;?>">
				        <label>Data Type <i class="icon-question agenttips" data-container="body" data-placement="right" data-original-title="Data type description"></i></span></label>
					...
					<!--<div class="form-group display-hide" id="taxonG<?php echo $idx;?>">
				        <label>Taxon  <i class="icon-question agenttips" data-container="body" data-placement="right" data-original-title="Taxon description"></i></span></label> 
				        <input type="text" id="taxon<?php echo $idx;?>" class="form-control taxon" placeholder="Please enter the taxon name" />
					</div>-->

					<div class="form-group display-hide" id="taxonG<?php echo $idx;?>">
          	<label class="control-label" id="label-taxon<?php echo $idx;?>">Taxon <i class="icon-question agenttips" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Insert the taxon for this file. You can provide it by name, ID, or avoid this step.</p>"></i></label>
					...
					<div class="form-group display-hide" id="refGenomeTR<?php echo $idx;?>">
				        <label>Assembly <i class="icon-question agenttips" data-container="body" data-placement="right" data-original-title="Assembly description"></i></span></label> 
				  ...
				  <!--<div class="form-group refGenomeTR" id="refGenomeTR<?php echo $idx;?>">
				        ...
				        <span class="agenttip-mt-radio"><i class="icon-question agenttips" data-container="body" data-placement="right" data-original-title="Assembly description"></i></span>
