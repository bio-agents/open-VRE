...
<head>
	...
	switch (pathinfo($_SERVER['PHP_SELF'])['filename']) {
		...
		case 'references': ?>
			...
			<?php break;
		case 'output': ?>
			<?php if (preg_match('agents/pydockdna',dirname($_SERVER['PHP_SELF'])) )  { ?>
				<link href="assets/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
				<link href="assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
			<?php } elseif (preg_match('agents/naflex',dirname($_SERVER['PHP_SELF'])) )  { ?>
				<link href="agents/naflex/css/styles.css" rel="stylesheet" type="text/css" />
			<?php } elseif (preg_match('agents/nucldynwf',dirname($_SERVER['PHP_SELF'])) ) { ?>
				<link href="assets/pages/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
				...
				<link href="assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
			<?php } elseif (preg_match('agents/nucldynwf_pmes',dirname($_SERVER['PHP_SELF'])) ) { ?>
				<link href="assets/pages/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />
				<link href="assets/global/plugins/datatables/plugins/fixedColumns/fixedColumns.dataTables.min.css" rel="stylesheet" type="text/css" />
				<link href="assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
			<?php } ?>
		...
		case 'input':
		case 'output': ?>
			<link href="assets/pages/css/customized-agents.css" rel="stylesheet" type="text/css" />
			<?php break;
		case 'agents':
		case 'visualizers': ?>
			<link href="assets/pages/css/portfolio.min.css" rel="stylesheet" type="text/css" />
