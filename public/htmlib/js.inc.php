...
switch(pathinfo($_SERVER['PHP_SELF'])['filename']){
	...
	case 'dashboard': ?>
		...
		<?php break;
	case 'input':?>
		<?php if(strrpos(dirname($_SERVER['PHP_SELF']), "agents")){ ?>
			<script src="assets/pages/scripts/agent-input.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
			<script src="assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
			<script src="assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
			<script src="assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
			<script src="assets/global/plugins/datatables/datatables.min.js" type="text/javascript"></script>
			...
			<script src="assets/global/plugins/typeahead/handlebars.min.js" type="text/javascript"></script>
			<script src="assets/global/plugins/typeahead/typeahead.bundle.min.js" type="text/javascript"></script>
			<script src="agents/<?php echo $agentId; ?>/assets/js/input.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		...
		<?php break;
	case 'output': ?>
		<?php if(preg_match('agents/agent_skeleton',dirname($_SERVER['PHP_SELF'])) ) { ?>
			<script src="assets/global/plugins/ngl.js" type="text/javascript"></script>
			<script src="assets/global/scripts/datatable.js" type="text/javascript"></script>
			<script src="assets/global/plugins/datatables/datatables.min.js" type="text/javascript"></script>
			<script src="assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
			<script src="agents/agent_skeleton/assets/js/output.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php } elseif(preg_match('agents/GMI_OD',dirname($_SERVER['PHP_SELF'])) ){ ?>
			<script src="agents/GMI_OD/assets/js/output.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php } elseif (preg_match('agents/TCGA_CD',dirname($_SERVER['PHP_SELF'])) ){ ?>
			<script src="agents/TCGA_CD/assets/js/output.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php } break;
	case 'help':
	case 'agenthelp':
	case 'method':
...
switch(pathinfo($_SERVER['PHP_SELF'])['filename']){
	...
	case 'index': ?>
		<?php if(basename(dirname($_SERVER['PHP_SELF'])) == 'workspace'){ ?>		
			...
			<script src="assets/pages/scripts/run-agents.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		...
		<?php } elseif(basename(dirname($_SERVER['PHP_SELF'])) == 'launch'){ ?>	
			<script src="assets/pages/scripts/launch-agent.js" type="text/javascript"></script>
		<?php } elseif((basename(dirname($_SERVER['PHP_SELF'])) == 'home') || (basename(dirname($_SERVER['PHP_SELF'])) == 'publicsite')){ ?>		
	...
	case 'editUser': 
		...
		<?php break; 
	case 'adminAgents': ?>
		<script src="assets/pages/scripts/adminAgents.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php break; 
	case 'adminJobs': ?>
		<script src="assets/pages/scripts/adminJobs.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php break; 
	case 'myNewAgents': ?>
		<script src="assets/pages/scripts/myNewAgents.js?v=<?php echo rand(); ?>" type="text/javascript"></script>	
		<?php break; 
	case 'newAgent': ?>
		<script src="assets/pages/scripts/newAgent.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php break; 
	case 'vmURL': ?>
	...
	case 'agents':
	case 'visualizers': ?>
		<script src="assets/pages/scripts/portfolio.agents.js?v=<?php echo rand(); ?>" type="text/javascript"></script>
		<?php break; 
	case 'sampleDataList': ?>
...
switch(pathinfo($_SERVER['PHP_SELF'])['filename']){
	...
	case 'logs':?>
		...
		<script src="assets/layouts/layout/scripts/cookie-agentbar.js" type="text/javascript"></script>
		<?php break; ?>
<?php } ?>
