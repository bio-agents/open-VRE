...
<!-- -------------------- HELP TEXT GOES HERE !!  ------------- -->
          ...
          <p>To launch a job using the VRE go to Run Agent / Visualizer and choose the agent you would like to use </p>				
          ...
          <p>Most of the agents have a customized View Results page, which is used to show the users the results of the agent properly. To view this special page users should click the View Results button:</p>
